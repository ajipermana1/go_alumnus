...
//     }else{
//         echo "<script>
//         alert ('Proses Daftar Gagal, Mohon Coba Lagi Nanti.);
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Silahkan Daftar</p>
              <form action="" method="post">
                  ...
                  <button type="submit" name="daftar" id="login" class="btn btn-block login-btn mb-4" type="button">Daftar</button>
                </form>
                <!-- <a href="#!" class="forgot-password-link">Forgot password?</a> -->
                <p class="login-card-footer-text">Sudah Punya Akun? <a href="login.php" class="text-reset">Login Sekarang!</a></p>
